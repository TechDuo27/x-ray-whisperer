// src/utils/diseaseDescriptions.ts
...
export const DISEASE_DESCRIPTIONS: Record<string, string> = {
  ...
  'CROWNS': 'Dental crowns are tooth-shaped caps that completely cover the visible portion of a damaged tooth above the gum line, restoring its shape, size, strength, and appearance. They are typically made from materials like porcelain, metal, or ceramic and appear radiopaque on radiographs.',
  
  'IMPLANTS': 'Dental implants are titanium posts surgically placed into the jawbone to replace missing tooth roots, providing a stable foundation for crowns, bridges, or dentures. They appear as highly radiopaque cylindrical or screw-shaped objects on radiographs and integrate with the surrounding bone through osseointegration.',
