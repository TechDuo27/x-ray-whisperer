...
export default function AnalysisView({ analysis, onBack }: AnalysisViewProps) {
  ...
  const getDescription = (detection: Detection): string => {
    return detection.description || `${detection.display_name} detected in the dental X-ray.`;
  };
      ...
      const reportContent = `
        ...
        <html lang="en">
          <head>
            ...
            <title>Oral Health Analyzer Report</title>
            <style>
              body { 
          ...
          <body>
            <div class="container">
              ...
              <div class="footer">
                <p>Generated by Oral Health Analyzer • ${new Date().toLocaleDateString()}</p>
              </div>
            </div>
          </body>
        </html>
