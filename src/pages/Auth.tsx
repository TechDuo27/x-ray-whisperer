...
export default function Auth() {
  ...
  // Check if user signed in with Google but needs to select user type
  useEffect(() => {
      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>
              Welcome {googleUserData?.fullName}! Please select your user type to continue.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <Button onClick={handleUserTypeSubmission} className="w-full" disabled={loading}>
                {loading ? (
                  <>
